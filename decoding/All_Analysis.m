...
for i = 1:8
    ...
    elseif i == 2 %Correct Response
        ...
        %WINDOWS
        cfg.outputdir = char(home+ "\Results\Flipped\Correct Reponse"); % output location

        %MAC
        cfg.outputdir = char(home+ "/Results/Flipped/CorrectReponse"); % output location        
    ...
    elseif i == 3 %Perceived Movement
        ...
        %WINDOWS
        cfg.outputdir = char(home+ "\Results\Flipped\Perceived_Movement"); % output location
    ...
    elseif i == 4 %Stimulus Movement
        ...
        %WINDOWS
        cfg.outputdir = char(home+ "\Results\Flipped\Stimulus_Movement"); % output location
    ...
    elseif i == 5 %CR vs FA
        ...
        %WINDOWS
        cfg.outputdir = char(home+ "\Results\Flipped\CR_vs_FA"); % output location
    ...
    elseif i == 6 %CR vs Miss
        ...
        %WINDOWS
        cfg.outputdir = char(home+ "\Results\Flipped\CR_vs_Miss"); % output location
    ...
    elseif i == 7 %Hit vs FA
        ...
        %WINDOWS
        cfg.outputdir = char(home+ "\Results\Flipped\Hit_vs_FA"); % output location
    ...
    elseif i == 8 %Hit vs Miss
        ...
        %WINDOWS
        cfg.outputdir = char(home+ "\Results\Flipped\Hit_vs_Miss"); % output location
